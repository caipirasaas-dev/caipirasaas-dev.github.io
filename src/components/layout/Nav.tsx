      ...
      <div className="container-content">
        <div className="flex h-16 items-center justify-between">
          <a href="#" className="brand flex items-center gap-2.5 font-bold tracking-tightest">
            <span className="grid h-[34px] w-[34px] place-items-center rounded-[9px] border border-green/25 bg-green-soft text-[18px] leading-none">
              🍹
            </span>
            <span className="text-[17px]">
              caipirasaas
              <span className="text-ink-300">.dev</span>
            </span>
          </a>

...
const services: Service[] = [
  {
    ...
    description:
      'Sistemas personalizados para processos que soluções prontas não resolvem.',
  },
  {
    icon: Cloud,
    title: 'Cloud & Infrastructure',
    description:
      'Arquitetura, infraestrutura como código, containers e ambientes de produção.',
  },
  {
    icon: Rocket,
    title: 'Delivery',
    description:
      'CI/CD, observabilidade e automação para colocar software em produção com confiança.',
  },
];
...
export default function Services() {
  return (
    <section id="servicos" className="container-content mt-20 sm:mt-24">
      ...
      <h2 className="section-heading">O que eu faço</h2>
